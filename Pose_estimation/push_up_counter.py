...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            if angle <= 90:
                stage_ = "Down"
            if angle > 90 and angle<=180 and stage_ =='Down':
                stage_="Up"
                counter_ +=1
                print("Left : ",counter_)
            ...
            if angle_r <= 90:
                stage_r = "Down"
            if angle_r>90 and angle_r<=180 and stage_r =='Down':
                stage_r="Up"
                counter_r +=1
        ...
        if counter_ > counter_r:
            cv2.putText(image, 'pushup uneven, please exert force from your left hand', (750,945), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (255,255,255), 2, cv2.LINE_AA)
        elif counter_r > counter_:
            cv2.putText(image, 'pushup uneven, please exert force from your right hand', (750,945), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (255,255,255), 2, cv2.LINE_AA)
